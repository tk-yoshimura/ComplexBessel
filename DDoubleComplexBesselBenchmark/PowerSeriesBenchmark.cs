    ...
    public class PowerSeriesBenchmark {
        ...
        public void BesselJTest() {
            for (double nu = -16; nu <= 16; nu += 0.25) {
                using StreamWriter sw = new($"../../../../results_ddouble/besselj_nu{nu}_powerseries_convergence.csv");
                ...
                for (double r = 0; r <= 42; r += 0.5) {
                    for (double i = 0; i <= 42; i += 0.5) {
                        ...
                        Complex zdd = PowerSeries.BesselJ(nu, (r, i));
        ...
        public void BesselYTest() {
            for (double nu = -16; nu <= 16; nu += 0.25) {
                using StreamWriter sw = new($"../../../../results_ddouble/bessely_nu{nu}_powerseries_convergence.csv");
                sw.WriteLine("r,i,relerr");
                ...
                for (double r = 0; r <= 42; r += 0.5) {
                    for (double i = 0; i <= 42; i += 0.5) {
                        ...
                        Complex zdd = PowerSeries.BesselY(nu, (r, i));
        ...
        public void BesselITest() {
            for (double nu = -16; nu <= 16; nu += 0.25) {
                using StreamWriter sw = new($"../../../../results_ddouble/besseli_nu{nu}_powerseries_convergence.csv");
                sw.WriteLine("r,i,relerr");
                ...
                for (double r = 0; r <= 42; r += 0.5) {
                    for (double i = 0; i <= 42; i += 0.5) {
                        ...
                        Complex zdd = PowerSeries.BesselI(nu, (r, i));
        ...
        public void BesselKTest() {
            for (double nu = 0; nu <= 16; nu += 0.25) {
                using StreamWriter sw = new($"../../../../results_ddouble/besselk_nu{nu}_powerseries_convergence.csv");
                sw.WriteLine("r,i,relerr");
                ...
                for (double r = 0; r <= 42; r += 0.5) {
                    for (double i = 0; i <= 42; i += 0.5) {
                        ...
                        Complex zdd = PowerSeries.BesselK(nu, (r, i));
